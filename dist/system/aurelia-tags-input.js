...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var bindable, bindingMode, computedFrom, _desc, _value, _class, _descriptor, _descriptor2, AureliaTagsInput;
  ...
  return {
    ...
    execute: function () {
      _export('AureliaTagsInput', AureliaTagsInput = (_class = function () {
